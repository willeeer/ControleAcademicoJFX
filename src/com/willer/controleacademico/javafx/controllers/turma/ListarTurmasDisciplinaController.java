...
public class ListarTurmasDisciplinaController implements IControllersInit
{
   ...
   @FXML
   public TableColumn<TurmaProfessor, String> nomeProfessor;
   ...
   private void loadStudents()
   {
      ...
      nomeProfessor.setCellValueFactory(new PropertyValueFactory<>("nomeProfessor"));
   ...
   @Override public void initData(Object o)
   {
      ...
      ArrayList<Turma> arrayTurmas = facade.recuperaTurmasDisciplina(d.getCodigo());
      ...
      for (Turma t : arrayTurmas)
      {
         ...
         turmaProf.setNomeProfessor(facade.buscaPessoa(t.getCpfProfessor(), true).getNome());
